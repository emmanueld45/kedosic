...
<body>
    ...
    <section class="form-component">
        <form action="tech-about-to-start2">
            <div class="form">
                ...
                <div class="row2">
                    ...
                    <label for="">State amd describr you product's features and services?</label>
                    <textarea name="" id="" class="textarea-field"></textarea>
                    ...
                    <label for="">How many persons are i your team?</label>
                    <select name="" id="" class="field">
                        <option>[1 - 5]</option>
                    </select>
